# Generated from sensu-extensions-only-check-output-1.0.0.gem by gem2rpm -*- rpm-spec -*-
%global gem_name sensu-extensions-only-check-output

Name:           rubygem-%{gem_name}
Version:        1.0.0
Release:        1%{?dist}
Summary:        The Sensu Core built-in only_check_output mutator
